                ...
                <div className="about-row">
                    ...
                    <h2 className="aboutTitle">A propos de moi</h2>
                        ...
                        <div className={`tab-contents ${activeTab === 'formations' ? 'active-tab' : ''}`} id="formations">
                            <ul>
                                <li><span>2023</span><br />Formation Développeur Intégrateur Web chez <a href="https://openclassrooms.com/fr/paths/594-integrateur-web" target="_blank" rel="noreferrer" className="aboutLink">OpenClassRooms</a> </li>
